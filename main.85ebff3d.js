...
function showAlert(message, className) {
  ...
  // Get container
  var container = document.querySelector('#pet-form-container');
  // Get form
...
function fetchAnimals(e) {
  ...
  if (!(0, _validate.isValidZip)(zip)) {
    (0, _validate.showAlert)('plese enter a valid zip code', 'danger');
    return;
  }

  // Fetch pets
  (0, _fetchJsonp2.default)('http://api.petfinder.com/pet.find?format=json&key=e2d4d86f5cbdc1aecf4a54c3bda01144&animal=' + animal + '&location=' + zip + '&callback=callback', {
...
// The argument 'pets' comes from the showAnimals function argudement in the .then()
...
},{"fetch-jsonp":"node_modules/fetch-jsonp/build/fetch-jsonp.js","./validate":"js/validate.js"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.85ebff3d.map